<?php
	...
	$q1 = mysql_query("SELECT * FROM karyawan WHERE username='$username' AND password='$pass' AND blokir='N' AND id_ju = 'JU-08'");
	...
	if (!ctype_alnum($username) OR !ctype_alnum($pass)){
		...
		$login	= mysql_query("SELECT * FROM karyawan WHERE username='$username' AND password='$pass' AND blokir='N' AND id_ju = 'JU-08'");
