...
$harian = date('Y-m-d');
$tgl = $_GET['tgl'];
	$p = mysql_fetch_array(mysql_query("SELECT *FROM history_kasir WHERE tanggal='$_GET[tanggal]' AND jenis='Treatment'"));
?>
<div align="center">
...
<div align="center">
	...
	<table width="100%" class="table1">
	    ...
	    <tbody>
		<?php $q1 = mysql_query("SELECT *FROM history_kasir WHERE tanggal='$_GET[tanggal]' AND jenis='Treatment'"); 
              $no =1;
