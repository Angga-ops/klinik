...
$harian = date('Y-m-d');
$tgl = $_GET['tgl'];
	$p = mysqli_fetch_array(mysqli_query($con,"SELECT *FROM history_kasir WHERE tanggal='$_GET[tanggal]' AND jenis='Treatment'"));
?>
<div align="center">
...
<div align="center">
	...
	<table width="100%" class="table1">
	    ...
	    <tbody>
		<?php $q1 = mysqli_query($con,"SELECT *FROM history_kasir WHERE tanggal='$_GET[tanggal]' AND jenis='Treatment'"); 
              $no =1;
	    ...
	    <tfoot>
					<tr>
						<td><b>TOTAL</b></td>
						<?php
			           $jumlahkan = "SELECT SUM(harga) AS total FROM history_kasir where tanggal='$_GET[tanggal]' AND jenis='Treatment'"; //perintah untuk menjumlahkan
