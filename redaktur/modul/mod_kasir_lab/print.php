...
$dt = mysqli_fetch_assoc(mysqli_query($con,"SELECT * FROM antrian_pasien a JOIN pasien b ON a.id_pasien = b.id_pasien WHERE a.no_faktur = '$_GET[faktur]'"));
...
<center>
			<h4 class="box-title">Detail Billing Laboratorium</h4>
		</center>
		<table>
<tr>
<td>
...
$u = mysqli_query($con,"SELECT * FROM history_kasir WHERE no_faktur = '$_GET[faktur]' ORDER BY kategori DESC");
