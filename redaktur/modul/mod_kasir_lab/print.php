...
$dt = mysql_fetch_assoc(mysql_query("SELECT * FROM antrian_pasien a JOIN pasien b ON a.id_pasien = b.id_pasien WHERE a.no_faktur = '$_GET[faktur]'"));
...
$u = mysql_query("SELECT * FROM history_kasir WHERE no_faktur = '$_GET[faktur]' ORDER BY kategori DESC");
