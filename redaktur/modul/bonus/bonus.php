...
$c = mysql_query("SELECT id,id_pasien,nama_pasien FROM pasien WHERE id_kk = '$_SESSION[klinik]'");
$d = '[';
...
$cx = mysql_query("SELECT kd_produk,nama_produk FROM produk_master WHERE id_kategori != 0");
$dx = '[';
...
<?php $bn = mysql_query("SELECT * FROM bonus WHERE username = '$_SESSION[namauser]'");
