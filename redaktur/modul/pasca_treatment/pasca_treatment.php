...
echo "<option value='$ko[id_dr]'>$dr[nama_lengkap]</option>";
							...
							<form style="margin-bottom: 20px;" id="form_produk" class="collapse">
					 		...
					 		<table class="xtbl" border='0' cellpadding='0' cellspacing='0' width='100%'>
					 			<tr>
					 			<td>
				 			...
				 			<tr>
				 				...
				 				<td>
				 					...
				 					<button type="button" style="margin-top: 15px;" class="btn btn-sm btn-danger" id="reset_t" data-id="<?php echo $_GET['nofak']; ?>">Reset Tabel</button>
				 				</td>
				 			</tr>
					 		</table>
					 	</form>
			...
			<form  enctype="multipart/form-data" id="form_pc" method="POST" action="modul/pasca_treatment/pc_selesai.php">
...
function previewFile(id) {
  ...
  $('#tabel_tp').dataTable( {
	"bPaginate": false,
      "bProcessing": true,
      "bServerSide": true,
      "sAjaxSource": "modul/pasca_treatment/data_tp.php?nofak="+nofak,
  ...
  // Hapus Perawatan
     $('body').on("click","#hapus_p",function(){
          ...
          $.ajax({
              type:'POST',
              url: 'modul/pasca_treatment/hapus.php',
              data:{
                id:id
              },
              success:function(data){
     ...
     // Reset Tabel Resep Obat
     $('body').on("click","#reset_t",function(){

          var id = $(this).data("id");
          $.ajax({
              type:'POST',
              url: 'modul/pasca_treatment/reset.php',
              data:{
                id:id
              },
              success:function(data){
