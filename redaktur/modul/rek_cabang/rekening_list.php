...
<section class="content">
    ...
    <div class="col-md-12">
         <div class="callout callout-success">
               <a href="?module=rek_cabang&act=tambah_rekening"> <button type="button" class="btn btn-warning btn-sm">Tambah Rekening</button></a>
 ...
 <div class="box box-success">
      ...
      <tbody>
    <?php
    $tampil   = mysqli_query($con,"Select * From rekening where id_kk='$id_kk'");
    ...
    ?>
      <tr class="gradeX">
            ...
            <td>
                     ...
                     <a href="?module=rek_cabang&act=edit_rekening&id_rekening=<?php echo $r["id_rekening"]; ?>" class="btn btn-xs btn-success"><i class="fa fa-edit"></i> Edit</a>&nbsp;<a onclick="return confirm('Yakin Ingin Menghapus Data?')" href="modul/rek_cabang/aksi_rekening.php?module=rekening&act=hapus&id_rekening=<?php echo $r['id_rekening']; ?>" class="btn btn-xs btn-danger"><i class="fa fa-trash-o"></i> Hapus</a>
...
<section class="content">
    ...
    <div class="col-md-12">
        ...
        <!-- /.box-header -->
        <div class="box-body"> <form method="post" enctype="multipart/form-data" action="modul/rek_cabang/aksi_rekening.php?module=rekening&act=input">
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                <label>Cabang Klinik</label>
                <select name="klinik" class="form-control" readonly>
      <?php
        $data     = mysqli_query($con,"Select * From daftar_klinik where id_kk='$id_kk'");            
      ...
      ?>
            ...
            <div class="col-md-12">
              <div class="form-group">
               <a href="?module=rek_cabang"><button type="button" class="btn btn-danger">Batal</button></a>
...
<section class="content">
    ...
    <div class="col-md-12">
        ...
        <!-- /.box-header -->
        <div class="box-body"> <form method="post" enctype="multipart/form-data" action="modul/rek_cabang/aksi_rekening.php?module=rekening&act=update">
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                <label>Cabang Klinik</label>
