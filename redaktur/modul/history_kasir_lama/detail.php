...
$dt = mysqli_fetch_assoc(mysqli_query($con, "SELECT * FROM antrian_pasien_lama a JOIN pasien b ON a.id_pasien = b.id_pasien WHERE a.no_faktur = '$_GET[faktur]'"));
...
$u = mysqli_query($con, "SELECT * FROM history_kasir_lama WHERE no_faktur = '$_GET[faktur]' ORDER BY kategori DESC");
...
$dr = mysqli_fetch_assoc(mysqli_query($con, "SELECT * FROM user WHERE id_user = $ux[id_dr]"));
