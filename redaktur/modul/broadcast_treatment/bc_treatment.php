...
<section class="content">
    ...
    <div class="col-md-12">
        ...
        <div class="box-header with-border">
          <h3 class="box-title">Broadcast Pesan Berdasarkan Jumlah Treatment</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body"> 
        <form method="post" enctype="multipart/form-data" action="modul/broadcast_treatment/aksi_broadcast.php">
          <div class="col-md-6">
           <div class="row">
            <div class="col-md-12">
              <div class="form-group">
           <label for="field4">Banyak Treatment</label>
            <input type="number" name="treatment" class="form-control" required="">
              </div>
              </div>
            </div>
            <div class="row">
...
<section class="content">
    ...
    <div class="col-md-12">
      ...
      <tbody>
    <?php
    $tampil   = mysqli_query($con, "Select * From broadcast_treatment");
    while($r  = mysqli_fetch_array($tampil)){
      $no=1;
    ?>
      <tr class="gradeX">
                <td>Lebih dari <?php echo $r["treatment"]; ?></td>
            ...
            <td>
                     ...
                     <a onclick="return confirm('Yakin Ingin Menghapus Data?')" href="modul/broadcast_treatment/hapus_broadcast.php?module=broadcast_treatment&act=hapus&id_broadcast=<?php echo $r['id_broadcast']; ?>" class="btn btn-xs btn-danger"><i class="fa fa-trash-o"></i> Hapus</a>
