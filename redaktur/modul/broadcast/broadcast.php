<section class="content">
    ...
    <div class="col-md-12">
        ...
        <!-- /.box-header -->
        <div class="box-body"> 
        <form method="post" enctype="multipart/form-data" action="modul/broadcast/aksi_broadcast.php">
          <div class="col-md-6">
           <div class="row">
            <div class="col-md-12">
    ...
    ?>
      <tr class="gradeX">
            ...
            <td>
                     ...
                     <a onclick="return confirm('Yakin Ingin Menghapus Data?')" href="modul/broadcast/hapus_broadcast.php?module=broadcast&act=hapus&id_broadcast=<?php echo $r['id_broadcast']; ?>" class="btn btn-xs btn-danger"><i class="fa fa-trash-o"></i> Hapus</a>
