...
<section class="content">
 ...
 <div class="box">
	...
	$tampil 	= mysql_query("SELECT * From jenis_user JOIN user Where jenis_user.id_ju=user.id_ju ");
		}else {
			$tampil 	= mysql_query("SELECT * From jenis_user JOIN karyawan Where jenis_user.id_ju=karyawan.id_ju AND id_karyawan='$_SESSION[id_user]' ");
		}
...
?>	
        ...
        <td>
             <?php if ($data['id_ju']!="JU-01" && $data['id_ju']!=$id_kk) {
              echo '
              <a href="?module=setuser_cabang&act=edit_user&id='.$data['id_karyawan'].'" class="btn btn-xs btn-success"><i class="fa fa-edit"></i> Edit</a>&nbsp';
             }else{
              echo " ";
             }
             ?>
...
<section class="content">
    ...
    <div class="col-md-12">
        ...
        <div class="box-body"> <form method="post" enctype="multipart/form-data" action="modul/setuser_cabang/aksi_user.php?module=setuser_cabang&act=input">
			...
			<?php
				$data			= mysql_query("Select * From jenis_user");            
            ...
            <div class="col-md-12">
              <div class="form-group">
                ...
                <select name="jenis_user" class="form-control" readonly>
                 <?php
                    $ju		= mysql_query("Select * From jenis_user WHERE id_ju='$data[id_ju]'");
                    if ($data['id_ju'] == '') {
                ?>
            ...
            <div class="col-md-12">
              <div class="form-group">
                ...
                <select name="cabang" class="form-control" readonly>
                 <?php
                    $ca   = mysql_query("Select * From daftar_klinik WHERE id_kk='$data[id_kk]'");
                    if ($data['id_kk'] =='') {
                ?>
