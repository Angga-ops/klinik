...
$idd = mysqli_fetch_array(mysqli_query($con, "SELECT * FROM daftar_klinik WHERE id_kk='$_GET[id_kk]'"));
	$p = mysqli_query($con, "SELECT no_faktur FROM history_kasir WHERE tanggal='$_GET[tanggal]' $id_kk  GROUP BY no_faktur");
