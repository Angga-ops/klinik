...
$id = mysqli_fetch_assoc(mysqli_query($con,"SELECT id FROM history_kasir ORDER BY id DESC LIMIT 1"));
echo $id['id'];


    break;
    case "hapus":
    mysqli_query($con,"DELETE FROM history_kasir WHERE id = '$_GET[id]'");
    break;
}
