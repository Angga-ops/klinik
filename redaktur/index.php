...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <link rel="stylesheet" href="assets/login/css/default-assets/classy-nav.css">
...
<script src="assets/login/js/jquery.min.js"></script>
    ...
    <!-- All Plugins -->
    <script src="assets/login/js/akame.bundle.js"></script>
    <!-- Active -->
    <script src="assets/login/js/default-assets/active.js"></script>
<script>
